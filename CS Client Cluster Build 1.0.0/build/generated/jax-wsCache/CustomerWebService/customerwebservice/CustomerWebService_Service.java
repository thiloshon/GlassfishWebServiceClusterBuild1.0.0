 ...
 * 
 */
@WebServiceClient(name = "CustomerWebService", targetNamespace = "http://CustomerWebService/", wsdlLocation = "http://localhost:8080/CustomerWebService/CustomerWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERWEBSERVICE_QNAME = new QName("http://CustomerWebService/", "CustomerWebService");
    ...
    public CustomerWebService getCustomerWebServicePort() {
        return super.getPort(new QName("http://CustomerWebService/", "CustomerWebServicePort"), CustomerWebService.class);
    }
    ...
    public CustomerWebService getCustomerWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://CustomerWebService/", "CustomerWebServicePort"), CustomerWebService.class, features);
    }
